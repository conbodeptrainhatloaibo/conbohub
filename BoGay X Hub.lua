...
Page.Name = "Page"
Page.Parent = Main
Page.BackgroundColor3 = Color3.fromRGB(255, 255, 0)
...
function main:Slider2(text,min,max,set,callback)
...
-------------------------------------------------------------------------------------------------------
local Add = Update:Window("Xeter","BLOX FRUIT",Enum.KeyCode.RightControl);
local I = Add:Tab("Information","rbxassetid://17405140638")
local Mn = Add:Tab("General","rbxassetid://10723407389")
local St = Add:Tab("Setting Farming","rbxassetid://10734950309")
local M = Add:Tab("Item & Quest","rbxassetid://10734975692")
local Ss = Add:Tab("Stats","rbxassetid://10709770317")
local V4 = Add:Tab("Race V4","rbxassetid://10747372167")
local E = Add:Tab("Sea Event","rbxassetid://10709761530")
local P = Add:Tab("Local Player","rbxassetid://10747373176")
local V = Add:Tab("Visual","rbxassetid://10723346959")
local R = Add:Tab("Raid","rbxassetid://10723345749")
local T = Add:Tab("Teleport","rbxassetid://10723434557")
local S = Add:Tab("Shop","rbxassetid://10734952479")
local D = Add:Tab("Devil Fruit","rbxassetid://10709761889")
local Mc = Add:Tab("Miscellaneous","rbxassetid://10709782582")
--------------------------------------------------------------------------------------------------------
...
I:Seperator("Status Elite")
local EliteProgress = I:Label("N/A")
    ...
    local Elite_Hunter_Status = I:Label("N/A")
...
I:Seperator("Status Bone")
BoneCheck = I:Label("Total Bone: N/A")
...
Mn:Dropdown("Select Weapon",WeaponList,function(value)
...
FarmMode = "Normal"
Mn:Dropdown("Select Farm Mode", ListF,function(value)
    FarmMode = value
end)

Mn:Seperator("Farming")

    Mn:Toggle("Auto Farm Level",_G.AutoFarm,function(value)
        _G.AutoFarm = value
            ...
            if FarmMode == "Normal" and _G.AutoFarm then
                pcall(function()
                    ...
                    if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false then
                        ...
                        CheckQuest()
                        if BypassTP then
                        if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - CFrameQuest.Position).Magnitude > 3000 then
						BTP(CFrameQuest)
            ...
            if FarmMode == "Not Tween To Npc Quest" and _G.AutoFarm then
                pcall(function()
                    ...
                    if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false then
                        ...
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StartQuest",NameQuest,LevelQuest)
                        if BypassTP then
                        if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - CFrameMon.Position).Magnitude > 3000 then
						BTP(CFrameMon)
...
if World1 then
    Mn:Toggle("Auto Farm Fast (Farm Lv.1-300)",_G.AutoFarmFast,function(value)
        _G.Farmfast = value
...
Mn:Toggle("Auto Kaitun",false,function(value)
       _G.AutoFarm = value
...
Mn:Dropdown("Select Mob",tableMon,function(vu)
    _G.SelectMob = vu
end)
    
    Mn:Toggle("Auto Farm Mob",_G.AutoFarmMob,function(value)
   ...
   Mn:Toggle("Auto Farm Nearest ",_G.AutoFarmNearest,function(value)
...
spawn(function()
    ...
    Mn:Toggle("Auto Elite Hunter",_G.AutoElitehunter,function(value)
        ...
        while wait() do
            if _G.AutoElitehunter and World3 then
                pcall(function()
                    ...
                    if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false then
                        if BypassTP then
                        if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - Elite.Position).Magnitude > 3000 then
						BTP(Elite)
    ...
    Mn:Toggle("Auto Elite Hunter Hop",_G.AutoEliteHunterHop,function(value)
        _G.AutoEliteHunterHop = value
    end)
       
Mn:Seperator("Chest Farm")
    
Mn:Toggle("Auto Farm Chest",false,function(value)
 AutoFarmChest = value
...
Mn:Toggle("Auto Farm Chest Mirage island",false,function(value)
...
Mn:Toggle("Auto Chest Bypass",false,function(vu)
	_G.ChestBypass = vu
end)
...
Mn:Toggle("Auto Chest Stop Torch",_G.STP,function(vu)
	Grab_Chest = vu
...
Mn:Toggle("Auto Farm Chest Hop",_G.AutoFarmChest_Hop,function(value)
    ...
    Mn:Toggle("Auto Pirates Raid", _G.AutoCarvender,function(value)
     _G.RaidPirate = value
        ...
        if _G.RaidPirate then
            pcall(function()
                ...
                if (CFrame.new(-5539.3115234375, 313.800537109375, -2972.372314453125).Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 500 then
                    ...
                    UnEquipWeapon(_G.SelectWeapon)
                    if BypassTP then
                    if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - CFrameBoss.Position).Magnitude > 3000 then
			        BTP(CFrameBoss)
...
Mn:Dropdown("Select Cake Farm Mode", ListC,function(value)
    CakeFMode = value
end)
    ...
    Mn:Toggle("Auto Farm Cake Prince",_G.AutoDoughtBoss,function(value)
                    ...
                    if game:GetService("Workspace").Enemies:FindFirstChild("Cake Prince") then
                        ...
                        if game:GetService("ReplicatedStorage"):FindFirstChild("Cake Prince [Lv. 2300] [Raid Boss]") then
                            ...
                            if game:GetService("Workspace").Map.CakeLoaf.BigMirror.Other.Transparency == 1 then
                                ...
                                if BypassTP then
                                if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - CakePos.Position).Magnitude > 3000 then
						        BTP(CakePos)
...
spawn(function()
            ...
            if CakeFMode == "AcceptQuest" and _G.AutoDoughtBoss and World3 and not game:GetService("ReplicatedStorage"):FindFirstChild("Cake Prince")  then
                pcall(function()
                    ...
                    if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false then
                        MagnetDought = false
                        if BypassTP then
                        if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - CakeQuestPos.Position).Magnitude > 3000 then
						BTP(CakeQuestPos)
    ...
    Mn:Toggle("Auto Spawn Cake Prince",false,function(value)
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner",value)
    end)
    
    Mn:Toggle("Auto Dough Boss v2", _G.Autodoughking,function(value)
         _G.Autodoughking = value
        StopTween( _G.Autodoughking)
    end)
    
    Mn:Toggle("Auto Dough Boss v2 Hop", _G.AutodoughkingHop,function(value)
...
Mn:Dropdown("Select Bone Farm Mode", ListB,function(value)
    BoneFMode = value
end)

    local BoneFarm = Mn:Toggle("Auto Farm Bone",_G.Auto_Bone,function(value)
        _G.Auto_Bone = value
   ...
   local BonePos = CFrame.new(-9506.234375, 172.130615234375, 6117.0771484375)
        ...
        while wait() do 
            if BoneFMode == "NoQuest" and _G.Auto_Bone and World3 then
                pcall(function()
                    ...
                    if BypassTP then
                    if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - BonePos.Position).Magnitude > 3000 then
			        BTP(BonePos)
            ...
            if  BoneFMode == "AcceptQuest" and _G.Auto_Bone and World3  then
                pcall(function()
                    ...
                    if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false then
                        StartMagnetBoneMon = false
                        if BypassTP then
                        if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - BoneQuestPos.Position).Magnitude > 3000 then
						BTP(BoneQuestPos)
    ...
    Mn:Toggle("Auto Random Surprise",_G.Auto_Random_Bone,function(value)
    ...
    Mn:Toggle("Auto Pray",pry,function(value)
    _G.Pray = value
    end)
    ...
    Mn:Toggle("Auto Try Luck",Trylux,function(value)
    _G.Trylux = value
    end)
   ...
   Mn:Seperator("Misc Mastery")
    ...
    Mn:Toggle("Auto Farm Fruit Mastery",_G.AutoFarmFruitMastery,function(value)
    ...
    Mn:Toggle("Auto Farm Gun Mastery",_G.AutoFarmGunMastery,function(value)
        _G.AutoFarmGunMastery = value
        StopTween(_G.AutoFarmGunMastery)
    end)
    
    Mn:Toggle("Auto Farm Sword Mastery",_G.AutoSwordMastery,function(value)
    ...
    Mn:Toggle("Auto Farm Observation",_G.AutoObservation,function(value)
...
local BossName = Mn:Dropdown("Select Boss", bossCheck, function(value)
    _G.SelectBoss = value
end)
...
for i, v in pairs(game:GetService("ReplicatedStorage"):GetChildren()) do
    ...
    Mn:Toggle("Auto Farm Boss",_G.AutoFarmBoss,function(value)
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
    ...
    Mn:Toggle("Auto Farm All Boss",_G.AutoAllBoss,function(value)
        _G.AutoAllBoss = value
        StopTween(_G.AutoAllBoss)
    end)
    
    Mn:Toggle("Auto Farm All Boss Hop",_G.AutoAllBossHop,function(value)
...
St:Toggle("Auto SetSpawn Point",true,function(value)
    _G.Set = value
end)
...
St:Toggle("Bypass TP",BypassTP,function(Fast)
BypassTP = Fast
end)
...
TweenSpeed = "325"
St:Dropdown("Speed Tween", SpeedList,function(Vale)
    TweenSpeed = Vale
end)
...
_G.BringMode = "Normal"
St:Dropdown("Bring Mob Mode", Bring,function(value)
    _G.BringMode = value
end)
spawn(function()
    while wait(.1) do
...
St:Toggle("Auto Haki",true,function(value)
_G.AUTOHAKI = value
end)
spawn(function()
    while wait(.1) do
...
St:Toggle("Fast Attack",true,function(value)
_G.FastAttack = value
end)      
...
spawn(function()
    ...
    spawn(function()
     ...
     St:Toggle("Attack Aura",true,function(value)
        _G.AttackMob = value
    end)
...
St:Dropdown("Fast Attack Delay", AttackList,function(SimpRose)
...
St:Toggle("Auto Click",false,function(value)
_G.AutoClick = value
end)

St:Toggle("Disabled Notifications Text",false,function(Xeter)
_G.Remove_trct = Xeter
end)
...
St:Toggle("White Screen",_G.WhiteScreen,function(value)
...
elseif _G.WhiteScreen == false then
    ...
    St:Toggle("Invisible Monsters",_G.inv,function(value)
    _G.inv = value
    ...
    St:Seperator("Setting Farm Mode")

    St:Label("Distance X Right Vector")
    St:Label("Distance Y Up Vector")
    St:Label("Distance Z Behind Vector")

    PosY = 25
    St:Slider("Pos Y Distance Farm",1,50,25,function(value)
    PosY = value
    end)

    St:Seperator("Misc Setting Mastery")
    
    _G.Kill_At = 25
    St:Slider("Kill At %",1,100,25,function(value)
        _G.Kill_At = value
    end)
    
 
    St:Toggle("Skill Z",true,function(value)
        _G.SkillZ = value
    end)
 
    
    St:Toggle("Skill X",true,function(value)
        _G.SkillX = value
    end)
    
    St:Toggle("Skill C",true,function(value)
        _G.SkillC = value
    end)
    
     St:Toggle("Skill V",true,function(value)
        _G.SkillV = value
    end)
--------------------------------------------------------------------------------------------------------
    V4:Seperator("World")
    ...
    elseif World3 then
V4:Toggle("Auto Mystic Island",_G.AutoMysticIsland,function(value)
...
V4:Toggle("Teleport Advanced Fruit Dealer",_G.TPNPC,function(value)
             _G.Miragenpc = value
...
V4:Toggle("Tween Gear",_G.TweenMGear,function(value)
_G.TweenMGear = value
        ...
        while wait() do
            if Radioactive and World2 then
                pcall(function()
                    ...
                    if BypassTP then
                    if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - MaterialsPos1.Position).Magnitude > 3000 then
			        BTP(MaterialsPos1)
        ...
        while wait() do
            if _G.Makori_gay and World2 then
                pcall(function()
                    ...
                    if BypassTP then
                    if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - MaterialsPos2.Position).Magnitude > 3000 then
			        BTP(MaterialsPos2)
        ...
        while wait() do
            if _G.Umm and World1 then
                pcall(function()
                    ...
                    if BypassTP then
                    if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - MaterialsPos3.Position).Magnitude > 3000 then
			        BTP(MaterialsPos3)
        ...
        while wait() do
            if _G.Umm and World2 then
                pcall(function()
                    ...
                    if BypassTP then
                    if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - MaterialsPos4.Position).Magnitude > 3000 then
			        BTP(MaterialsPos4)
        ...
        while wait() do
            if _G.Auto_Wing and World1 then
                pcall(function()
                    ...
                    if BypassTP then
                    if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - MaterialsPos5.Position).Magnitude > 3000 then
			        BTP(MaterialsPos5)
        ...
        while wait() do
            if _G.Leather and World1 then
                pcall(function()
                    ...
                    if BypassTP then
                    if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - MaterialsPos6.Position).Magnitude > 3000 then
			        BTP(MaterialsPos6)
        ...
        while wait() do
            if _G.Leather and World2 then
                pcall(function()
                    ...
                    if BypassTP then
                    if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - MaterialsPos7.Position).Magnitude > 3000 then
			        BTP(MaterialsPos7)
        ...
        while wait() do
            if _G.Leather and World3 then
                pcall(function()
                    ...
                    if BypassTP then
                    if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - MaterialsPos8.Position).Magnitude > 3000 then
			        BTP(MaterialsPos8)
        ...
        while wait() do
            if Scrap and World1 then
                pcall(function()
                    ...
                    if BypassTP then
                    if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - MaterialsPos9.Position).Magnitude > 3000 then
			        BTP(MaterialsPos9)
        ...
        while wait() do
            if Scrap and World2 then
                pcall(function()
                    ...
                    if BypassTP then
                    if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - MaterialsPos10.Position).Magnitude > 3000 then
			        BTP(MaterialsPos10)
        ...
        while wait() do
            if Scrap and World3 then
                pcall(function()
                    ...
                    if BypassTP then
                    if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - MaterialsPos11.Position).Magnitude > 3000 then
			        BTP(MaterialsPos11)
        ...
        while wait() do
            if Cocoafarm and World3 then
                pcall(function()
                    ...
                    if BypassTP then
                    if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - MaterialsPos12.Position).Magnitude > 3000 then
			        BTP(MaterialsPos12)
        ...
        while wait() do
            if Dragon_Scale and World3 then
                pcall(function()
                    ...
                    if BypassTP then
                    if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - MaterialsPos13.Position).Magnitude > 3000 then
			        BTP(MaterialsPos13)
        ...
        while wait() do
            if Gunpowder and World3 then
                pcall(function()
                    ...
                    if BypassTP then
                    if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - MaterialsPos14.Position).Magnitude > 3000 then
			        BTP(MaterialsPos14)
        ...
        while wait() do
            if Fish and World3 then
                pcall(function()
                    ...
                    if BypassTP then
                    if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - MaterialsPos15.Position).Magnitude > 3000 then
			        BTP(MaterialsPos15)
        ...
        while wait() do
            if MiniHee and World3 then
                pcall(function()
                    ...
                    if BypassTP then
                    if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - MaterialsPos16.Position).Magnitude > 3000 then
			        BTP(MaterialsPos16)
        ...
        while wait() do
            if _G.AutoBudySword and World3 then
                pcall(function()
                    ...
                    if BypassTP then
                    if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - BigMomPos.Position).Magnitude > 3000 then
			        BTP(BigMomPos)
        ...
        while wait() do
            if  _G.Autotushita and World3 then
                pcall(function()
                    ...
                    if BypassTP then
                    if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - TushitaPos.Position).Magnitude > 3000 then
			        BTP(TushitaPos)
        ...
        while wait() do
            if  _G.AutoCarvender and World3 then
                pcall(function()
                    ...
                    if BypassTP then
                    if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - CavandisPos.Position).Magnitude > 3000 then
			        BTP(CavandisPos)
        ...
        while wait() do
            if  _G.AutoTwinHook and World3 then
                pcall(function()
                    ...
                    if BypassTP then
                    if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - ElephantPos.Position).Magnitude > 3000 then
			        BTP(ElephantPos)
				...
				pcall(function()
					if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
						if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text,"Training Dummy") or string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text,"Training Dummy") or string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text,"Training Dummy") then
							...
							if BypassTP then
                            if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - GGPos.Position).Magnitude > 3000 then
			                BTP(GGPos)
        ...
        pcall(function()
            while wait() do
                if _G.AutoDarkDagger then
                    ...
                    if BypassTP then
                    if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - AdminPos.Position).Magnitude > 3000 then
			        BTP(AdminPos)
        ...
        while wait() do
            if  _G.Auto_Dragon_Trident and World2 then
                pcall(function()
                    ...
                    if BypassTP then
                    if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - TridentPos.Position).Magnitude > 3000 then
			        BTP(TridentPos)
        ...
        while wait() do
            if  _G.Autogay and World1 then
                pcall(function()
                    ...
                    if BypassTP then
                    if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - GayMakPos.Position).Magnitude > 3000 then
			        BTP(GayMakPos)
        ...
        while wait() do
            if  _G.Autopole and World1 then
                pcall(function()
                    ...
                    if BypassTP then
                    if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - PolePos.Position).Magnitude > 3000 then
			        BTP(PolePos)
        ...
        while wait() do
            if  _G.Autosaw and World1 then
                pcall(function()
                    ...
                    if BypassTP then
                    if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - SharkPos.Position).Magnitude > 3000 then
			        BTP(SharkPos)
...
V4:Toggle("Auto Buy Gear",_G.Auto_Farm_Bone4,function(value)
...
V4:Toggle("Disabled Inf Stairs", nil, function(value)
...
V4:Button("Teleport To Clock",function()
  ...
  V4:Toggle("Trial All Race V4",false,function(v)
  _G.AutoQuestRace = v
...
V4:Toggle("Auto Lock Moon",_G.LockCamToMoon,function(value)
...
V4:Toggle("Kill Player After Trial",false,function(value)
...
--------------------------------------------------------------------------------------------------------
    ...
    E:Toggle('Teleport to Seabaeat', false, function(value)
...
E:Toggle("Auto Sea Baest [Fully]",_G.Auto_Seabest,function(value)
...
E:Toggle("Destroy Boat if found SeaBeast or Player Health 0",_G.AutoDesBoat,function(value)
...
E:Toggle('Ennable Hop Sea Event Farm', false, function(value)
    _G.AutoSeaBestHop = value
    end)

E:Seperator("Rough Sea")
    
    E:Toggle("Auto Drive Boat", _G.AppleAutoDriveBoat,function(value)
    ...
    E:Toggle("Auto Farm Terrorshark", _G.AutoTerrorshark,function(value)
         _G.AutoTerrorshark = value
        StopTween( _G.AutoTerrorshark)
    end)
    
    E:Toggle("Auto Farm Shark",FarmTFully,function(value)
    FarmShark = value
    StopTween(FarmShark)
    end)
    ...
    E:Toggle("Auto Farm Piranha",_G.farmpiranya,function(value)
    _G.farmpiranya = value
    StopTween(_G.farmpiranya)
    end)
    
    E:Toggle("Auto Fish Crew Member",_G.Fish_Crew_Member,function(value)
    _G.Fish_Crew_Member = value
    StopTween(_G.Fish_Crew_Member)
    end)
    
    E:Toggle("Auto Terrorshark Hop", _G.AutoTerrorsharkhop,function(value)
    ...
    E:Toggle("Auto Raid Ship",_G.KillGhostShip,function(value)
    ...
    E:Toggle("Auto Ghost Ship",_G.bjirFishBoat,function(value)
...
spawn(function()
    ...
    E:Toggle("Auto Frozen Dimension",_G.AutoFrozenDimension,function(value)
    ...
    E:Toggle("Auto Kitsunen Island",_G.AutoFKitsune,function(value)
...
E:Toggle("Teleporter Kitsune", false, function(value)
    _G.tpkit = value
    StopTween(_G.tpkit)
end)
...
E:Toggle("Auto Collect Azure Ember", false, function(value)
    _G.lumlinhhon = value
...
V:Toggle("ESP Island Kitsune",false,function(value)
        IslandESP = value
...
V:Toggle("ESP Island",IslandESP,function(value)
        IslandESP = value
        while IslandESP do wait()
            UpdateIslandESP() 
        end
    end)
    V:Toggle("Esp Npc", false, function(nec)
    NpcESP = nec
end)

V:Toggle("Esp Sea Beast", false, function(nec)
    SeaESP = nec
end)

V:Toggle("Esp Mob", false, function(nec)
    MobESP = nec
end)

V:Toggle("Esp Mystic Island", false, function(value)
...
V:Toggle("Esp Advanced Fruit Dealer", false, function(value)
    AfdESP = value
...
V:Toggle("Esp Gear", false, function(value)
    GearESP = value
...
game:GetService('StarterGui'):SetCoreGuiEnabled(Enum.CoreGuiType.PlayerList, true)   
    ...
    V:Toggle("Highlight Mode",false,function(value)
        if value == true then
...
V:Toggle("Graphic",false,function(v)
	...
	V:Toggle("Xray",false,function(value)
		NoWorld = value
...
V:Button("Kaitun Cap", function(value)
...
V:Toggle("Remove Fog",RemoveFog,function(value)
    RemoveFog = value
    ...
    V:Toggle("Dodge No Cooldown",false,function(value)
        nododgecool = value
        NoDodgeCool()
    end)
    
    V:Toggle("Infinite Energy",false,function(value)
        InfiniteEnergy = value
        originalstam = LocalPlayer.Character.Energy.Value
    end)
    
    V:Toggle("Auto Active Race",_G.AutoAgility,function(value)
    ...
    V:Toggle("Infinite Ability",false,function(value)
        InfAbility = value
        if value == false then
            game:GetService("Players").LocalPlayer.Character.HumanoidRootPart:FindFirstChild("Agility"):Destroy()
        end
    ...
    V:Toggle("Auto Use Awakening",_G.AutoAwakeningRace,function(value)
    ...
    V:Toggle("Infinite Obversation Range",getgenv().InfiniteObRange,function(value)
    ...
    V:Toggle("Infinite Geppo",getgenv().InfGeppo,function(value)
    ...
    V:Toggle("Infinite Soru",getgenv().InfSoru,function(value)
    ...
    V:Toggle("Walk on Water",false,function(value)
        _G.WalkWater = value
    end)
    ...
    V:Toggle("NoClip",_G.NOCLIP,function(value)
        _G.NOCLIP = value
    end)
...
--------------------------------------------------------------------------------------------------------
    ...
    Mc:Textbox("Place Job Id", true, function(value)
	_G.Job = value
	end)
    ...
    Mc:Button("Open Inventory Fruit",function()
...
repeat wait() until game:IsLoaded() 
	...
	Mc:Toggle("Auto Rejoin",true,function(value)
		_G.AutoRejoin = value
	end)
    ...
    Mc:Dropdown("Selected Codes Reset stat",{"NOOB_REFUND","SUB2GAMERROBOT_RESET1","Sub2UncleKizaru"},function(value)
        _G.CodeSelect = value
    end)
    ...
    Mc:Dropdown("Select Haki State",{"State 0","State 1","State 2","State 3","State 4","State 5"},function(value)
...
ImageButton1.Size = UDim2.new(0, 52, 0, 52)
ImageButton1.Draggable = false
ImageButton1.Image = "http://www.roblox.com/asset/?id=17646240219"
...
game:GetService("StarterGui"):SetCore("SendNotification", {
    Title = "ConBoGay X Hub";
    Text = "Thành Công";
    Icon = "rbxthumb://type=Asset&id=17646240219&w=150&h=150";
    Duration = "Number"
})